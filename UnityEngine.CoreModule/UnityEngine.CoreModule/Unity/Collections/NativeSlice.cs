...
namespace Unity.Collections
{
	...
	{
		// Token: 0x060002B3 RID: 691 RVA: 0x000051CE File Offset: 0x000033CE
		public NativeSlice(NativeSlice<T> slice, int start)
		{
			this = new NativeSlice<T>(slice, start, slice.Length - start);
		}

		// Token: 0x060002B4 RID: 692 RVA: 0x000051E3 File Offset: 0x000033E3
		...
		// Token: 0x060002B9 RID: 697 RVA: 0x00005288 File Offset: 0x00003488
		...
		// Token: 0x060002BA RID: 698 RVA: 0x000052CC File Offset: 0x000034CC
		...
		// Token: 0x060002BB RID: 699 RVA: 0x00005308 File Offset: 0x00003508
		...
		// Token: 0x060002C0 RID: 704 RVA: 0x0000535F File Offset: 0x0000355F
		[WriteAccessRequired]
		...
		// Token: 0x060002C1 RID: 705 RVA: 0x00005394 File Offset: 0x00003594
		[WriteAccessRequired]
		...
		// Token: 0x060002C2 RID: 706 RVA: 0x000053E8 File Offset: 0x000035E8
		...
		// Token: 0x060002C3 RID: 707 RVA: 0x00005424 File Offset: 0x00003624
		...
		// Token: 0x060002C4 RID: 708 RVA: 0x00005478 File Offset: 0x00003678
		public T[] ToArray()
		{
		...
		// (get) Token: 0x060002C5 RID: 709 RVA: 0x0000549F File Offset: 0x0000369F
		public int Stride
		{
			get
			{
		...
		// (get) Token: 0x060002C6 RID: 710 RVA: 0x000054A8 File Offset: 0x000036A8
		public int Length
		{
			get
			{
		...
		// Token: 0x060002C7 RID: 711 RVA: 0x000054C0 File Offset: 0x000036C0
		public NativeSlice<T>.Enumerator GetEnumerator()
		{
			return new NativeSlice<T>.Enumerator(ref this);
		}

		// Token: 0x060002C8 RID: 712 RVA: 0x000054D8 File Offset: 0x000036D8
		IEnumerator<T> IEnumerable<T>.GetEnumerator()
		{
			return new NativeSlice<T>.Enumerator(ref this);
		}

		// Token: 0x060002C9 RID: 713 RVA: 0x000054F8 File Offset: 0x000036F8
		IEnumerator IEnumerable.GetEnumerator()
		{
			return this.GetEnumerator();
		}

		// Token: 0x060002CA RID: 714 RVA: 0x00005518 File Offset: 0x00003718
		...
		// Token: 0x060002CB RID: 715 RVA: 0x00005558 File Offset: 0x00003758
		...
		// Token: 0x060002CC RID: 716 RVA: 0x00005590 File Offset: 0x00003790
		...
		// Token: 0x060002CD RID: 717 RVA: 0x000055CC File Offset: 0x000037CC
		public static bool operator ==(NativeSlice<T> left, NativeSlice<T> right)
		{
			return left.Equals(right);
		}

		// Token: 0x060002CE RID: 718 RVA: 0x000055E8 File Offset: 0x000037E8
		public static bool operator !=(NativeSlice<T> left, NativeSlice<T> right)
		{
			return !left.Equals(right);
		}
		...
		{
			// Token: 0x060002CF RID: 719 RVA: 0x00005605 File Offset: 0x00003805
			...
			// Token: 0x060002D1 RID: 721 RVA: 0x0000561C File Offset: 0x0000381C
			...
			// Token: 0x060002D2 RID: 722 RVA: 0x0000564F File Offset: 0x0000384F
			public void Reset()
			{
				this.m_Index = -1;
			}
			...
			// (get) Token: 0x060002D3 RID: 723 RVA: 0x00005659 File Offset: 0x00003859
			public T Current
			{
				get
				{
			...
			// (get) Token: 0x060002D4 RID: 724 RVA: 0x0000566C File Offset: 0x0000386C
