...
namespace Unity.Collections
{
	...
	public struct NativeArray<T> : IDisposable, IEnumerable<T>, IEnumerable, IEquatable<NativeArray<T>> where T : struct
	{
		...
		public struct Enumerator : IEnumerator<T>, IEnumerator, IDisposable
		{
			...
			// Token: 0x06000291 RID: 657 RVA: 0x00004E1C File Offset: 0x0000301C
			[MethodImpl(256)]
			...
			// Token: 0x06000292 RID: 658 RVA: 0x00004E81 File Offset: 0x00003081
			public void Reset()
			{
				this.m_Index = -1;
			}
			...
			// (get) Token: 0x06000293 RID: 659 RVA: 0x00004E8C File Offset: 0x0000308C
			public T Current
			{
				[MethodImpl(256)]
				get
			...
			// (get) Token: 0x06000294 RID: 660 RVA: 0x00004EA4 File Offset: 0x000030A4
		...
		{
			// Token: 0x06000295 RID: 661 RVA: 0x00004EC1 File Offset: 0x000030C1
			...
			// (get) Token: 0x06000296 RID: 662 RVA: 0x00004ED4 File Offset: 0x000030D4
			public int Length
			{
				[MethodImpl(256)]
				get
			...
			// Token: 0x06000297 RID: 663 RVA: 0x00004EEC File Offset: 0x000030EC
			public void CopyTo(T[] array)
			{
				NativeArray<T>.Copy(this, array);
			}

			// Token: 0x06000298 RID: 664 RVA: 0x00004EFB File Offset: 0x000030FB
			public void CopyTo(NativeArray<T> array)
			{
				NativeArray<T>.Copy(this, array);
			}

			// Token: 0x06000299 RID: 665 RVA: 0x00004F0C File Offset: 0x0000310C
			public T[] ToArray()
			{
			...
			// Token: 0x0600029A RID: 666 RVA: 0x00004F40 File Offset: 0x00003140
			...
			// Token: 0x0600029C RID: 668 RVA: 0x00004F84 File Offset: 0x00003184
			[Conditional("ENABLE_UNITY_COLLECTIONS_CHECKS")]
			[MethodImpl(256)]
			private void CheckElementReadAccess(int index)
			{
			...
			// (get) Token: 0x0600029D RID: 669 RVA: 0x00004FC6 File Offset: 0x000031C6
			public bool IsCreated
			{
				[MethodImpl(256)]
				get
			...
			// Token: 0x0600029E RID: 670 RVA: 0x00004FD8 File Offset: 0x000031D8
			public NativeArray<T>.ReadOnly.Enumerator GetEnumerator()
			{
				return new NativeArray<T>.ReadOnly.Enumerator(in this);
			}

			// Token: 0x0600029F RID: 671 RVA: 0x00004FF0 File Offset: 0x000031F0
			IEnumerator<T> IEnumerable<T>.GetEnumerator()
			{
				return this.GetEnumerator();
			}

			// Token: 0x060002A0 RID: 672 RVA: 0x00005010 File Offset: 0x00003210
			IEnumerator IEnumerable.GetEnumerator()
			{
				return this.GetEnumerator();
			}
			...
			public struct Enumerator : IEnumerator<T>, IEnumerator, IDisposable
			{
				// Token: 0x060002A1 RID: 673 RVA: 0x0000502D File Offset: 0x0000322D
				...
				// Token: 0x060002A3 RID: 675 RVA: 0x00005050 File Offset: 0x00003250
				[MethodImpl(256)]
				public bool MoveNext()
				{
					this.m_Index++;
				...
				// Token: 0x060002A4 RID: 676 RVA: 0x000050B5 File Offset: 0x000032B5
				public void Reset()
				{
					this.m_Index = -1;
				}
				...
				// (get) Token: 0x060002A5 RID: 677 RVA: 0x000050BF File Offset: 0x000032BF
				public T Current
				{
					[MethodImpl(256)]
					get
				...
				// (get) Token: 0x060002A6 RID: 678 RVA: 0x000050C7 File Offset: 0x000032C7
				object IEnumerator.Current
				{
					get
					{
