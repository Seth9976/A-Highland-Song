...
namespace UnityEngine
{
	...
	{
		// Token: 0x06000807 RID: 2055 RVA: 0x0000C117 File Offset: 0x0000A317
		internal Display()
		{
			this.nativeDisplay = new IntPtr(0);
		}

		// Token: 0x06000808 RID: 2056 RVA: 0x0000C12D File Offset: 0x0000A32D
		...
		// (get) Token: 0x06000809 RID: 2057 RVA: 0x0000C140 File Offset: 0x0000A340
		...
		// (get) Token: 0x0600080A RID: 2058 RVA: 0x0000C168 File Offset: 0x0000A368
		...
		// (get) Token: 0x0600080B RID: 2059 RVA: 0x0000C190 File Offset: 0x0000A390
		...
		// (get) Token: 0x0600080C RID: 2060 RVA: 0x0000C1B8 File Offset: 0x0000A3B8
		...
		// (get) Token: 0x0600080D RID: 2061 RVA: 0x0000C1E0 File Offset: 0x0000A3E0
		...
		// (get) Token: 0x0600080E RID: 2062 RVA: 0x0000C204 File Offset: 0x0000A404
		...
		// (get) Token: 0x0600080F RID: 2063 RVA: 0x0000C228 File Offset: 0x0000A428
		public bool active
		{
			get
			{
		...
		// (get) Token: 0x06000810 RID: 2064 RVA: 0x0000C248 File Offset: 0x0000A448
		...
		// (get) Token: 0x06000811 RID: 2065 RVA: 0x0000C2AC File Offset: 0x0000A4AC
		...
		// Token: 0x06000812 RID: 2066 RVA: 0x0000C2C9 File Offset: 0x0000A4C9
		public void Activate()
		{
			Display.ActivateDisplayImpl(this.nativeDisplay, 0, 0, 60);
		}

		// Token: 0x06000813 RID: 2067 RVA: 0x0000C2DC File Offset: 0x0000A4DC
		public void Activate(int width, int height, int refreshRate)
		{
			Display.ActivateDisplayImpl(this.nativeDisplay, width, height, refreshRate);
		}

		// Token: 0x06000814 RID: 2068 RVA: 0x0000C2EE File Offset: 0x0000A4EE
		public void SetParams(int width, int height, int x, int y)
		{
			Display.SetParamsImpl(this.nativeDisplay, width, height, x, y);
		}

		// Token: 0x06000815 RID: 2069 RVA: 0x0000C302 File Offset: 0x0000A502
		public void SetRenderingResolution(int w, int h)
		{
			Display.SetRenderingResolutionImpl(this.nativeDisplay, w, h);
		}

		// Token: 0x06000816 RID: 2070 RVA: 0x0000C314 File Offset: 0x0000A514
		...
		// Token: 0x06000817 RID: 2071 RVA: 0x0000C328 File Offset: 0x0000A528
		...
		// (get) Token: 0x06000818 RID: 2072 RVA: 0x0000C378 File Offset: 0x0000A578
		...
		// (get) Token: 0x06000819 RID: 2073 RVA: 0x0000C390 File Offset: 0x0000A590
		// (set) Token: 0x0600081A RID: 2074 RVA: 0x0000C3A7 File Offset: 0x0000A5A7
		...
		// Token: 0x0600081B RID: 2075 RVA: 0x0000C3B0 File Offset: 0x0000A5B0
		...
		// Token: 0x0600081C RID: 2076 RVA: 0x0000C404 File Offset: 0x0000A604
		[RequiredByNativeCode]
		...
		// (add) Token: 0x0600081D RID: 2077 RVA: 0x0000C42C File Offset: 0x0000A62C
		// (remove) Token: 0x0600081E RID: 2078 RVA: 0x0000C460 File Offset: 0x0000A660
		...
		// Token: 0x06000829 RID: 2089 RVA: 0x0000C493 File Offset: 0x0000A693
