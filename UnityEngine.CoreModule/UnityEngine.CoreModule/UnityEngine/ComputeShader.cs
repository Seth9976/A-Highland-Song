...
namespace UnityEngine
{
	...
	public sealed class ComputeShader : Object
	{
		...
		// Token: 0x06001824 RID: 6180 RVA: 0x000274FB File Offset: 0x000256FB
		...
		// Token: 0x06001825 RID: 6181 RVA: 0x00027506 File Offset: 0x00025706
		...
		// Token: 0x0600182F RID: 6191 RVA: 0x00027511 File Offset: 0x00025711
		public void SetBuffer(int kernelIndex, int nameID, ComputeBuffer buffer)
		{
			this.Internal_SetBuffer(kernelIndex, nameID, buffer);
		}

		// Token: 0x06001830 RID: 6192 RVA: 0x0002751E File Offset: 0x0002571E
		...
		// (get) Token: 0x06001837 RID: 6199 RVA: 0x0002752C File Offset: 0x0002572C
		...
		// Token: 0x0600183B RID: 6203 RVA: 0x00027542 File Offset: 0x00025742
		[FreeFunction("ComputeShaderScripting::EnableKeyword", HasExplicitThis = true)]
		...
		// Token: 0x0600183C RID: 6204 RVA: 0x0002754C File Offset: 0x0002574C
		[FreeFunction("ComputeShaderScripting::DisableKeyword", HasExplicitThis = true)]
		...
		// Token: 0x0600183D RID: 6205 RVA: 0x00027556 File Offset: 0x00025756
		...
		// Token: 0x0600183E RID: 6206 RVA: 0x00027561 File Offset: 0x00025761
		[FreeFunction("ComputeShaderScripting::IsKeywordEnabled", HasExplicitThis = true)]
		...
		// (get) Token: 0x06001846 RID: 6214 RVA: 0x000275BC File Offset: 0x000257BC
		// (set) Token: 0x06001847 RID: 6215 RVA: 0x000275D4 File Offset: 0x000257D4
		...
		// (get) Token: 0x0600184A RID: 6218 RVA: 0x000275E0 File Offset: 0x000257E0
		// (set) Token: 0x0600184B RID: 6219 RVA: 0x000275F8 File Offset: 0x000257F8
		...
		// Token: 0x0600184C RID: 6220 RVA: 0x0000E87A File Offset: 0x0000CA7A
		private ComputeShader()
		{
		}

		// Token: 0x0600184D RID: 6221 RVA: 0x00027603 File Offset: 0x00025803
		public void SetFloat(string name, float val)
		{
			this.SetFloat(Shader.PropertyToID(name), val);
		}

		// Token: 0x0600184E RID: 6222 RVA: 0x00027614 File Offset: 0x00025814
		public void SetInt(string name, int val)
		{
			this.SetInt(Shader.PropertyToID(name), val);
		}

		// Token: 0x0600184F RID: 6223 RVA: 0x00027625 File Offset: 0x00025825
		public void SetVector(string name, Vector4 val)
		{
			this.SetVector(Shader.PropertyToID(name), val);
		}

		// Token: 0x06001850 RID: 6224 RVA: 0x00027636 File Offset: 0x00025836
		public void SetMatrix(string name, Matrix4x4 val)
		{
			this.SetMatrix(Shader.PropertyToID(name), val);
		}

		// Token: 0x06001851 RID: 6225 RVA: 0x00027647 File Offset: 0x00025847
		public void SetVectorArray(string name, Vector4[] values)
		{
			this.SetVectorArray(Shader.PropertyToID(name), values);
		}

		// Token: 0x06001852 RID: 6226 RVA: 0x00027658 File Offset: 0x00025858
		public void SetMatrixArray(string name, Matrix4x4[] values)
		{
			this.SetMatrixArray(Shader.PropertyToID(name), values);
		}

		// Token: 0x06001853 RID: 6227 RVA: 0x00027669 File Offset: 0x00025869
		public void SetFloats(string name, params float[] values)
		{
			this.SetFloatArray(Shader.PropertyToID(name), values);
		}

		// Token: 0x06001854 RID: 6228 RVA: 0x0002767A File Offset: 0x0002587A
		public void SetFloats(int nameID, params float[] values)
		{
			this.SetFloatArray(nameID, values);
		}

		// Token: 0x06001855 RID: 6229 RVA: 0x00027686 File Offset: 0x00025886
		public void SetInts(string name, params int[] values)
		{
			this.SetIntArray(Shader.PropertyToID(name), values);
		}

		// Token: 0x06001856 RID: 6230 RVA: 0x00027697 File Offset: 0x00025897
		public void SetInts(int nameID, params int[] values)
		{
			this.SetIntArray(nameID, values);
		}

		// Token: 0x06001857 RID: 6231 RVA: 0x000276A3 File Offset: 0x000258A3
		public void SetBool(string name, bool val)
		{
			this.SetInt(Shader.PropertyToID(name), val ? 1 : 0);
		}

		// Token: 0x06001858 RID: 6232 RVA: 0x000276BA File Offset: 0x000258BA
		public void SetBool(int nameID, bool val)
		{
			this.SetInt(nameID, val ? 1 : 0);
		}

		// Token: 0x06001859 RID: 6233 RVA: 0x000276CC File Offset: 0x000258CC
		public void SetTexture(int kernelIndex, int nameID, Texture texture)
		{
			this.SetTexture(kernelIndex, nameID, texture, 0);
		}

		// Token: 0x0600185A RID: 6234 RVA: 0x000276DA File Offset: 0x000258DA
		public void SetTexture(int kernelIndex, string name, Texture texture)
		{
			this.SetTexture(kernelIndex, Shader.PropertyToID(name), texture, 0);
		}

		// Token: 0x0600185B RID: 6235 RVA: 0x000276ED File Offset: 0x000258ED
		...
		// Token: 0x0600185C RID: 6236 RVA: 0x00027701 File Offset: 0x00025901
		...
		// Token: 0x0600185D RID: 6237 RVA: 0x00027712 File Offset: 0x00025912
		...
		// Token: 0x0600185E RID: 6238 RVA: 0x00027728 File Offset: 0x00025928
		...
		// Token: 0x0600185F RID: 6239 RVA: 0x0002773F File Offset: 0x0002593F
		public void SetBuffer(int kernelIndex, string name, ComputeBuffer buffer)
		{
			this.SetBuffer(kernelIndex, Shader.PropertyToID(name), buffer);
		}

		// Token: 0x06001860 RID: 6240 RVA: 0x00027751 File Offset: 0x00025951
		public void SetBuffer(int kernelIndex, string name, GraphicsBuffer buffer)
		{
			this.SetBuffer(kernelIndex, Shader.PropertyToID(name), buffer);
		}

		// Token: 0x06001861 RID: 6241 RVA: 0x00027763 File Offset: 0x00025963
		public void SetConstantBuffer(int nameID, ComputeBuffer buffer, int offset, int size)
		{
			this.SetConstantComputeBuffer(nameID, buffer, offset, size);
		}

		// Token: 0x06001862 RID: 6242 RVA: 0x00027772 File Offset: 0x00025972
		...
		// Token: 0x06001863 RID: 6243 RVA: 0x00027786 File Offset: 0x00025986
		...
		// Token: 0x06001864 RID: 6244 RVA: 0x00027795 File Offset: 0x00025995
		public void SetConstantBuffer(string name, GraphicsBuffer buffer, int offset, int size)
		{
			this.SetConstantBuffer(Shader.PropertyToID(name), buffer, offset, size);
		}

		// Token: 0x06001865 RID: 6245 RVA: 0x000277AC File Offset: 0x000259AC
		...
		// Token: 0x06001866 RID: 6246 RVA: 0x000277F6 File Offset: 0x000259F6
		[ExcludeFromDocs]
		...
		// Token: 0x06001867 RID: 6247 RVA: 0x00027804 File Offset: 0x00025A04
		...
		// Token: 0x06001868 RID: 6248 RVA: 0x0002784E File Offset: 0x00025A4E
		[ExcludeFromDocs]
