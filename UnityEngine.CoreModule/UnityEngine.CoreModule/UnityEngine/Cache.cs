...
namespace UnityEngine
{
	...
	public struct Cache : IEquatable<Cache>
	{
		...
		// (get) Token: 0x0600044D RID: 1101 RVA: 0x00006FFC File Offset: 0x000051FC
		internal int handle
		{
			get
			{
		...
		// Token: 0x0600044E RID: 1102 RVA: 0x00007014 File Offset: 0x00005214
		public static bool operator ==(Cache lhs, Cache rhs)
		{
			return lhs.handle == rhs.handle;
		}

		// Token: 0x0600044F RID: 1103 RVA: 0x00007038 File Offset: 0x00005238
		public static bool operator !=(Cache lhs, Cache rhs)
		{
			return lhs.handle != rhs.handle;
		}

		// Token: 0x06000450 RID: 1104 RVA: 0x00007060 File Offset: 0x00005260
		public override int GetHashCode()
		{
			return this.m_Handle;
		}

		// Token: 0x06000451 RID: 1105 RVA: 0x00007078 File Offset: 0x00005278
		public override bool Equals(object other)
		{
			return other is Cache && this.Equals((Cache)other);
		}

		// Token: 0x06000452 RID: 1106 RVA: 0x000070A4 File Offset: 0x000052A4
		...
		// (get) Token: 0x06000453 RID: 1107 RVA: 0x000070C8 File Offset: 0x000052C8
		public bool valid
		{
			get
			{
		...
		// (get) Token: 0x06000455 RID: 1109 RVA: 0x000070E8 File Offset: 0x000052E8
		public bool ready
		{
			get
			{
		...
		// (get) Token: 0x06000457 RID: 1111 RVA: 0x00007108 File Offset: 0x00005308
		...
		// (get) Token: 0x06000459 RID: 1113 RVA: 0x00007128 File Offset: 0x00005328
		public string path
		{
			get
			{
		...
		// (get) Token: 0x0600045B RID: 1115 RVA: 0x00007148 File Offset: 0x00005348
		public int index
		{
			get
			{
		...
		// (get) Token: 0x0600045D RID: 1117 RVA: 0x00007168 File Offset: 0x00005368
		...
		// (get) Token: 0x0600045F RID: 1119 RVA: 0x00007188 File Offset: 0x00005388
		// (set) Token: 0x06000460 RID: 1120 RVA: 0x000071A5 File Offset: 0x000053A5
		...
		// (get) Token: 0x06000463 RID: 1123 RVA: 0x000071B8 File Offset: 0x000053B8
		...
		// (get) Token: 0x06000465 RID: 1125 RVA: 0x000071D8 File Offset: 0x000053D8
		// (set) Token: 0x06000466 RID: 1126 RVA: 0x000071F5 File Offset: 0x000053F5
		...
		// Token: 0x06000469 RID: 1129 RVA: 0x00007208 File Offset: 0x00005408
		...
		// Token: 0x0600046B RID: 1131 RVA: 0x00007228 File Offset: 0x00005428
