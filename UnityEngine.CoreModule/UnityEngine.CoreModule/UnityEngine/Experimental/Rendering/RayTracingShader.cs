...
namespace UnityEngine.Experimental.Rendering
{
	...
	public sealed class RayTracingShader : Object
	{
		...
		// Token: 0x06002897 RID: 10391 RVA: 0x0004313D File Offset: 0x0004133D
		...
		// Token: 0x06002898 RID: 10392 RVA: 0x00043148 File Offset: 0x00041348
		...
		// Token: 0x060028A6 RID: 10406 RVA: 0x00043153 File Offset: 0x00041353
		public void SetBuffer(int nameID, GraphicsBuffer buffer)
		{
			this.SetGraphicsBuffer(nameID, buffer);
		}

		// Token: 0x060028A7 RID: 10407 RVA: 0x0000E87A File Offset: 0x0000CA7A
		private RayTracingShader()
		{
		}

		// Token: 0x060028A8 RID: 10408 RVA: 0x0004315F File Offset: 0x0004135F
		public void SetFloat(string name, float val)
		{
			this.SetFloat(Shader.PropertyToID(name), val);
		}

		// Token: 0x060028A9 RID: 10409 RVA: 0x00043170 File Offset: 0x00041370
		public void SetInt(string name, int val)
		{
			this.SetInt(Shader.PropertyToID(name), val);
		}

		// Token: 0x060028AA RID: 10410 RVA: 0x00043181 File Offset: 0x00041381
		public void SetVector(string name, Vector4 val)
		{
			this.SetVector(Shader.PropertyToID(name), val);
		}

		// Token: 0x060028AB RID: 10411 RVA: 0x00043192 File Offset: 0x00041392
		public void SetMatrix(string name, Matrix4x4 val)
		{
			this.SetMatrix(Shader.PropertyToID(name), val);
		}

		// Token: 0x060028AC RID: 10412 RVA: 0x000431A3 File Offset: 0x000413A3
		public void SetVectorArray(string name, Vector4[] values)
		{
			this.SetVectorArray(Shader.PropertyToID(name), values);
		}

		// Token: 0x060028AD RID: 10413 RVA: 0x000431B4 File Offset: 0x000413B4
		public void SetMatrixArray(string name, Matrix4x4[] values)
		{
			this.SetMatrixArray(Shader.PropertyToID(name), values);
		}

		// Token: 0x060028AE RID: 10414 RVA: 0x000431C5 File Offset: 0x000413C5
		public void SetFloats(string name, params float[] values)
		{
			this.SetFloatArray(Shader.PropertyToID(name), values);
		}

		// Token: 0x060028AF RID: 10415 RVA: 0x000431D6 File Offset: 0x000413D6
		public void SetFloats(int nameID, params float[] values)
		{
			this.SetFloatArray(nameID, values);
		}

		// Token: 0x060028B0 RID: 10416 RVA: 0x000431E2 File Offset: 0x000413E2
		public void SetInts(string name, params int[] values)
		{
			this.SetIntArray(Shader.PropertyToID(name), values);
		}

		// Token: 0x060028B1 RID: 10417 RVA: 0x000431F3 File Offset: 0x000413F3
		public void SetInts(int nameID, params int[] values)
		{
			this.SetIntArray(nameID, values);
		}

		// Token: 0x060028B2 RID: 10418 RVA: 0x000431FF File Offset: 0x000413FF
		public void SetBool(string name, bool val)
		{
			this.SetInt(Shader.PropertyToID(name), val ? 1 : 0);
		}

		// Token: 0x060028B3 RID: 10419 RVA: 0x00043216 File Offset: 0x00041416
		public void SetBool(int nameID, bool val)
		{
			this.SetInt(nameID, val ? 1 : 0);
		}

		// Token: 0x060028B4 RID: 10420 RVA: 0x00043228 File Offset: 0x00041428
		public void SetTexture(string name, Texture texture)
		{
			this.SetTexture(Shader.PropertyToID(name), texture);
		}

		// Token: 0x060028B5 RID: 10421 RVA: 0x00043239 File Offset: 0x00041439
		public void SetBuffer(string name, ComputeBuffer buffer)
		{
			this.SetBuffer(Shader.PropertyToID(name), buffer);
		}

		// Token: 0x060028B6 RID: 10422 RVA: 0x0004324A File Offset: 0x0004144A
		public void SetBuffer(string name, GraphicsBuffer buffer)
		{
			this.SetBuffer(Shader.PropertyToID(name), buffer);
		}

		// Token: 0x060028B7 RID: 10423 RVA: 0x0004325B File Offset: 0x0004145B
		public void SetConstantBuffer(int nameID, ComputeBuffer buffer, int offset, int size)
		{
			this.SetConstantComputeBuffer(nameID, buffer, offset, size);
		}

		// Token: 0x060028B8 RID: 10424 RVA: 0x0004326A File Offset: 0x0004146A
		...
		// Token: 0x060028B9 RID: 10425 RVA: 0x0004327E File Offset: 0x0004147E
		...
		// Token: 0x060028BA RID: 10426 RVA: 0x0004328D File Offset: 0x0004148D
		...
		// Token: 0x060028BB RID: 10427 RVA: 0x000432A1 File Offset: 0x000414A1
		...
		// Token: 0x060028BC RID: 10428 RVA: 0x000432B2 File Offset: 0x000414B2
