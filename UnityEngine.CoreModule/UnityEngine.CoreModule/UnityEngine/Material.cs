...
namespace UnityEngine
{
	...
	{
		// Token: 0x06000CFB RID: 3323 RVA: 0x00011464 File Offset: 0x0000F664
		...
		// Token: 0x06000CFF RID: 3327 RVA: 0x0001147C File Offset: 0x0000F67C
		public Material(Shader shader)
		{
			Material.CreateWithShader(this, shader);
		}

		// Token: 0x06000D00 RID: 3328 RVA: 0x0001148E File Offset: 0x0000F68E
		...
		// Token: 0x06000D01 RID: 3329 RVA: 0x000114A0 File Offset: 0x0000F6A0
		[EditorBrowsable(1)]
		...
		// (get) Token: 0x06000D07 RID: 3335 RVA: 0x000114B4 File Offset: 0x0000F6B4
		// (set) Token: 0x06000D08 RID: 3336 RVA: 0x000114F4 File Offset: 0x0000F6F4
		public Color color
		{
			get
			{
		...
		// (get) Token: 0x06000D09 RID: 3337 RVA: 0x00011534 File Offset: 0x0000F734
		// (set) Token: 0x06000D0A RID: 3338 RVA: 0x00011574 File Offset: 0x0000F774
		...
		// (get) Token: 0x06000D0B RID: 3339 RVA: 0x000115B4 File Offset: 0x0000F7B4
		// (set) Token: 0x06000D0C RID: 3340 RVA: 0x000115F4 File Offset: 0x0000F7F4
		...
		// (get) Token: 0x06000D0D RID: 3341 RVA: 0x00011634 File Offset: 0x0000F834
		// (set) Token: 0x06000D0E RID: 3342 RVA: 0x00011674 File Offset: 0x0000F874
		...
		// Token: 0x06000D11 RID: 3345 RVA: 0x000116B4 File Offset: 0x0000F8B4
		...
		// Token: 0x06000D13 RID: 3347 RVA: 0x000116D4 File Offset: 0x0000F8D4
		public bool HasFloat(string name)
		{
			return this.HasFloatImpl(Shader.PropertyToID(name));
		}

		// Token: 0x06000D14 RID: 3348 RVA: 0x000116F4 File Offset: 0x0000F8F4
		public bool HasFloat(int nameID)
		{
			return this.HasFloatImpl(nameID);
		}

		// Token: 0x06000D15 RID: 3349 RVA: 0x00011710 File Offset: 0x0000F910
		public bool HasInt(string name)
		{
			return this.HasFloatImpl(Shader.PropertyToID(name));
		}

		// Token: 0x06000D16 RID: 3350 RVA: 0x00011730 File Offset: 0x0000F930
		...
		// Token: 0x06000D18 RID: 3352 RVA: 0x0001174C File Offset: 0x0000F94C
		public bool HasInteger(string name)
		{
			return this.HasIntImpl(Shader.PropertyToID(name));
		}

		// Token: 0x06000D19 RID: 3353 RVA: 0x0001176C File Offset: 0x0000F96C
		...
		// Token: 0x06000D1B RID: 3355 RVA: 0x00011788 File Offset: 0x0000F988
		public bool HasTexture(string name)
		{
			return this.HasTextureImpl(Shader.PropertyToID(name));
		}

		// Token: 0x06000D1C RID: 3356 RVA: 0x000117A8 File Offset: 0x0000F9A8
		...
		// Token: 0x06000D1E RID: 3358 RVA: 0x000117C4 File Offset: 0x0000F9C4
		public bool HasMatrix(string name)
		{
			return this.HasMatrixImpl(Shader.PropertyToID(name));
		}

		// Token: 0x06000D1F RID: 3359 RVA: 0x000117E4 File Offset: 0x0000F9E4
		...
		// Token: 0x06000D21 RID: 3361 RVA: 0x00011800 File Offset: 0x0000FA00
		public bool HasVector(string name)
		{
			return this.HasVectorImpl(Shader.PropertyToID(name));
		}

		// Token: 0x06000D22 RID: 3362 RVA: 0x00011820 File Offset: 0x0000FA20
		public bool HasVector(int nameID)
		{
			return this.HasVectorImpl(nameID);
		}

		// Token: 0x06000D23 RID: 3363 RVA: 0x0001183C File Offset: 0x0000FA3C
		public bool HasColor(string name)
		{
			return this.HasVectorImpl(Shader.PropertyToID(name));
		}

		// Token: 0x06000D24 RID: 3364 RVA: 0x0001185C File Offset: 0x0000FA5C
		...
		// Token: 0x06000D26 RID: 3366 RVA: 0x00011878 File Offset: 0x0000FA78
		public bool HasBuffer(string name)
		{
			return this.HasBufferImpl(Shader.PropertyToID(name));
		}

		// Token: 0x06000D27 RID: 3367 RVA: 0x00011898 File Offset: 0x0000FA98
		...
		// Token: 0x06000D29 RID: 3369 RVA: 0x000118B4 File Offset: 0x0000FAB4
		public bool HasConstantBuffer(string name)
		{
			return this.HasConstantBufferImpl(Shader.PropertyToID(name));
		}

		// Token: 0x06000D2A RID: 3370 RVA: 0x000118D4 File Offset: 0x0000FAD4
		...
		// Token: 0x06000D31 RID: 3377 RVA: 0x000118ED File Offset: 0x0000FAED
		...
		// Token: 0x06000D32 RID: 3378 RVA: 0x000118F7 File Offset: 0x0000FAF7
		...
		// Token: 0x06000D33 RID: 3379 RVA: 0x00011901 File Offset: 0x0000FB01
		...
		// Token: 0x06000D34 RID: 3380 RVA: 0x0001190C File Offset: 0x0000FB0C
		...
		// (get) Token: 0x06000D3B RID: 3387 RVA: 0x00011968 File Offset: 0x0000FB68
		// (set) Token: 0x06000D3C RID: 3388 RVA: 0x00011980 File Offset: 0x0000FB80
		...
		// Token: 0x06000D4A RID: 3402 RVA: 0x0001198C File Offset: 0x0000FB8C
		public string GetTag(string tag, bool searchFallbacks, string defaultValue)
		{
			return this.GetTagImpl(tag, !searchFallbacks, defaultValue);
		}

		// Token: 0x06000D4B RID: 3403 RVA: 0x000119AC File Offset: 0x0000FBAC
		...
		// (get) Token: 0x06000D51 RID: 3409 RVA: 0x000119D0 File Offset: 0x0000FBD0
		// (set) Token: 0x06000D52 RID: 3410 RVA: 0x000119E8 File Offset: 0x0000FBE8
		...
		// Token: 0x06000D58 RID: 3416 RVA: 0x000119F4 File Offset: 0x0000FBF4
		...
		// Token: 0x06000D59 RID: 3417 RVA: 0x00011A20 File Offset: 0x0000FC20
		...
		// Token: 0x06000D5C RID: 3420 RVA: 0x00011A4A File Offset: 0x0000FC4A
		...
		// Token: 0x06000D5D RID: 3421 RVA: 0x00011A55 File Offset: 0x0000FC55
		...
		// Token: 0x06000D66 RID: 3430 RVA: 0x00011A60 File Offset: 0x0000FC60
		...
		// Token: 0x06000D67 RID: 3431 RVA: 0x00011A78 File Offset: 0x0000FC78
		...
		// Token: 0x06000D79 RID: 3449 RVA: 0x00011A90 File Offset: 0x0000FC90
		...
		// Token: 0x06000D7A RID: 3450 RVA: 0x00011AA7 File Offset: 0x0000FCA7
		...
		// Token: 0x06000D7B RID: 3451 RVA: 0x00011AB2 File Offset: 0x0000FCB2
		...
		// Token: 0x06000D7C RID: 3452 RVA: 0x00011AC0 File Offset: 0x0000FCC0
		...
		// Token: 0x06000D7D RID: 3453 RVA: 0x00011B14 File Offset: 0x0000FD14
		...
		// Token: 0x06000D7E RID: 3454 RVA: 0x00011B68 File Offset: 0x0000FD68
		...
		// Token: 0x06000D7F RID: 3455 RVA: 0x00011BBC File Offset: 0x0000FDBC
		...
		// Token: 0x06000D80 RID: 3456 RVA: 0x00011C10 File Offset: 0x0000FE10
		...
		// Token: 0x06000D81 RID: 3457 RVA: 0x00011C68 File Offset: 0x0000FE68
		...
		// Token: 0x06000D82 RID: 3458 RVA: 0x00011CC0 File Offset: 0x0000FEC0
		...
		// Token: 0x06000D83 RID: 3459 RVA: 0x00011D18 File Offset: 0x0000FF18
		...
		// Token: 0x06000D84 RID: 3460 RVA: 0x00011D6D File Offset: 0x0000FF6D
		public void SetInt(string name, int value)
		{
			this.SetFloatImpl(Shader.PropertyToID(name), (float)value);
		}

		// Token: 0x06000D85 RID: 3461 RVA: 0x00011D7F File Offset: 0x0000FF7F
		public void SetInt(int nameID, int value)
		{
			this.SetFloatImpl(nameID, (float)value);
		}

		// Token: 0x06000D86 RID: 3462 RVA: 0x00011D8C File Offset: 0x0000FF8C
		public void SetFloat(string name, float value)
		{
			this.SetFloatImpl(Shader.PropertyToID(name), value);
		}

		// Token: 0x06000D87 RID: 3463 RVA: 0x00011D9D File Offset: 0x0000FF9D
		public void SetFloat(int nameID, float value)
		{
			this.SetFloatImpl(nameID, value);
		}

		// Token: 0x06000D88 RID: 3464 RVA: 0x00011DA9 File Offset: 0x0000FFA9
		public void SetInteger(string name, int value)
		{
			this.SetIntImpl(Shader.PropertyToID(name), value);
		}

		// Token: 0x06000D89 RID: 3465 RVA: 0x00011DBA File Offset: 0x0000FFBA
		public void SetInteger(int nameID, int value)
		{
			this.SetIntImpl(nameID, value);
		}

		// Token: 0x06000D8A RID: 3466 RVA: 0x00011DC6 File Offset: 0x0000FFC6
		public void SetColor(string name, Color value)
		{
			this.SetColorImpl(Shader.PropertyToID(name), value);
		}

		// Token: 0x06000D8B RID: 3467 RVA: 0x00011DD7 File Offset: 0x0000FFD7
		public void SetColor(int nameID, Color value)
		{
			this.SetColorImpl(nameID, value);
		}

		// Token: 0x06000D8C RID: 3468 RVA: 0x00011DE3 File Offset: 0x0000FFE3
		public void SetVector(string name, Vector4 value)
		{
			this.SetColorImpl(Shader.PropertyToID(name), value);
		}

		// Token: 0x06000D8D RID: 3469 RVA: 0x00011DF9 File Offset: 0x0000FFF9
		public void SetVector(int nameID, Vector4 value)
		{
			this.SetColorImpl(nameID, value);
		}

		// Token: 0x06000D8E RID: 3470 RVA: 0x00011E0A File Offset: 0x0001000A
		public void SetMatrix(string name, Matrix4x4 value)
		{
			this.SetMatrixImpl(Shader.PropertyToID(name), value);
		}

		// Token: 0x06000D8F RID: 3471 RVA: 0x00011E1B File Offset: 0x0001001B
		public void SetMatrix(int nameID, Matrix4x4 value)
		{
			this.SetMatrixImpl(nameID, value);
		}

		// Token: 0x06000D90 RID: 3472 RVA: 0x00011E27 File Offset: 0x00010027
		public void SetTexture(string name, Texture value)
		{
			this.SetTextureImpl(Shader.PropertyToID(name), value);
		}

		// Token: 0x06000D91 RID: 3473 RVA: 0x00011E38 File Offset: 0x00010038
		public void SetTexture(int nameID, Texture value)
		{
			this.SetTextureImpl(nameID, value);
		}

		// Token: 0x06000D92 RID: 3474 RVA: 0x00011E44 File Offset: 0x00010044
		...
		// Token: 0x06000D93 RID: 3475 RVA: 0x00011E56 File Offset: 0x00010056
		...
		// Token: 0x06000D9B RID: 3483 RVA: 0x00011ED4 File Offset: 0x000100D4
		...
		// Token: 0x06000DA1 RID: 3489 RVA: 0x00011F55 File Offset: 0x00010155
		...
		// Token: 0x06000DA9 RID: 3497 RVA: 0x00012001 File Offset: 0x00010201
		public void SetMatrixArray(int nameID, List<Matrix4x4> values)
		{
			this.SetMatrixArray(nameID, NoAllocHelpers.ExtractArrayFromListT<Matrix4x4>(values), values.Count);
		}

		// Token: 0x06000DAA RID: 3498 RVA: 0x00012018 File Offset: 0x00010218
		public void SetMatrixArray(string name, Matrix4x4[] values)
		{
			this.SetMatrixArray(Shader.PropertyToID(name), values, values.Length);
		}

		// Token: 0x06000DAB RID: 3499 RVA: 0x0001202C File Offset: 0x0001022C
		public void SetMatrixArray(int nameID, Matrix4x4[] values)
		{
			this.SetMatrixArray(nameID, values, values.Length);
		}

		// Token: 0x06000DAC RID: 3500 RVA: 0x0001203C File Offset: 0x0001023C
		public int GetInt(string name)
		{
			return (int)this.GetFloatImpl(Shader.PropertyToID(name));
		}

		// Token: 0x06000DAD RID: 3501 RVA: 0x0001205C File Offset: 0x0001025C
		public int GetInt(int nameID)
		{
			return (int)this.GetFloatImpl(nameID);
		}

		// Token: 0x06000DAE RID: 3502 RVA: 0x00012078 File Offset: 0x00010278
		public float GetFloat(string name)
		{
			return this.GetFloatImpl(Shader.PropertyToID(name));
		}

		// Token: 0x06000DAF RID: 3503 RVA: 0x00012098 File Offset: 0x00010298
		public float GetFloat(int nameID)
		{
			return this.GetFloatImpl(nameID);
		}

		// Token: 0x06000DB0 RID: 3504 RVA: 0x000120B4 File Offset: 0x000102B4
		public int GetInteger(string name)
		{
			return this.GetIntImpl(Shader.PropertyToID(name));
		}

		// Token: 0x06000DB1 RID: 3505 RVA: 0x000120D4 File Offset: 0x000102D4
		public int GetInteger(int nameID)
		{
			return this.GetIntImpl(nameID);
		}

		// Token: 0x06000DB2 RID: 3506 RVA: 0x000120F0 File Offset: 0x000102F0
		public Color GetColor(string name)
		{
			return this.GetColorImpl(Shader.PropertyToID(name));
		}

		// Token: 0x06000DB3 RID: 3507 RVA: 0x00012110 File Offset: 0x00010310
		public Color GetColor(int nameID)
		{
			return this.GetColorImpl(nameID);
		}

		// Token: 0x06000DB4 RID: 3508 RVA: 0x0001212C File Offset: 0x0001032C
		public Vector4 GetVector(string name)
		{
			return this.GetColorImpl(Shader.PropertyToID(name));
		}

		// Token: 0x06000DB5 RID: 3509 RVA: 0x00012150 File Offset: 0x00010350
		public Vector4 GetVector(int nameID)
		{
			return this.GetColorImpl(nameID);
		}

		// Token: 0x06000DB6 RID: 3510 RVA: 0x00012170 File Offset: 0x00010370
		public Matrix4x4 GetMatrix(string name)
		{
			return this.GetMatrixImpl(Shader.PropertyToID(name));
		}

		// Token: 0x06000DB7 RID: 3511 RVA: 0x00012190 File Offset: 0x00010390
		public Matrix4x4 GetMatrix(int nameID)
		{
			return this.GetMatrixImpl(nameID);
		}

		// Token: 0x06000DB8 RID: 3512 RVA: 0x000121AC File Offset: 0x000103AC
		public Texture GetTexture(string name)
		{
			return this.GetTextureImpl(Shader.PropertyToID(name));
		}

		// Token: 0x06000DB9 RID: 3513 RVA: 0x000121CC File Offset: 0x000103CC
		public Texture GetTexture(int nameID)
		{
			return this.GetTextureImpl(nameID);
		}

		// Token: 0x06000DBA RID: 3514 RVA: 0x000121E8 File Offset: 0x000103E8
		public float[] GetFloatArray(string name)
		{
			return this.GetFloatArray(Shader.PropertyToID(name));
		}

		// Token: 0x06000DBB RID: 3515 RVA: 0x00012208 File Offset: 0x00010408
		public float[] GetFloatArray(int nameID)
		{
			return (this.GetFloatArrayCountImpl(nameID) != 0) ? this.GetFloatArrayImpl(nameID) : null;
		}

		// Token: 0x06000DBC RID: 3516 RVA: 0x00012230 File Offset: 0x00010430
		public Color[] GetColorArray(string name)
		{
			return this.GetColorArray(Shader.PropertyToID(name));
		}

		// Token: 0x06000DBD RID: 3517 RVA: 0x00012250 File Offset: 0x00010450
		public Color[] GetColorArray(int nameID)
		{
			return (this.GetColorArrayCountImpl(nameID) != 0) ? this.GetColorArrayImpl(nameID) : null;
		}

		// Token: 0x06000DBE RID: 3518 RVA: 0x00012278 File Offset: 0x00010478
		public Vector4[] GetVectorArray(string name)
		{
			return this.GetVectorArray(Shader.PropertyToID(name));
		}

		// Token: 0x06000DBF RID: 3519 RVA: 0x00012298 File Offset: 0x00010498
		public Vector4[] GetVectorArray(int nameID)
		{
			return (this.GetVectorArrayCountImpl(nameID) != 0) ? this.GetVectorArrayImpl(nameID) : null;
		}

		// Token: 0x06000DC0 RID: 3520 RVA: 0x000122C0 File Offset: 0x000104C0
		public Matrix4x4[] GetMatrixArray(string name)
		{
			return this.GetMatrixArray(Shader.PropertyToID(name));
		}

		// Token: 0x06000DC1 RID: 3521 RVA: 0x000122E0 File Offset: 0x000104E0
		public Matrix4x4[] GetMatrixArray(int nameID)
		{
			return (this.GetMatrixArrayCountImpl(nameID) != 0) ? this.GetMatrixArrayImpl(nameID) : null;
		}

		// Token: 0x06000DC2 RID: 3522 RVA: 0x00012305 File Offset: 0x00010505
		public void GetFloatArray(string name, List<float> values)
		{
			this.ExtractFloatArray(Shader.PropertyToID(name), values);
		}

		// Token: 0x06000DC3 RID: 3523 RVA: 0x00012316 File Offset: 0x00010516
		public void GetFloatArray(int nameID, List<float> values)
		{
			this.ExtractFloatArray(nameID, values);
		}

		// Token: 0x06000DC4 RID: 3524 RVA: 0x00012322 File Offset: 0x00010522
		public void GetColorArray(string name, List<Color> values)
		{
			this.ExtractColorArray(Shader.PropertyToID(name), values);
		}

		// Token: 0x06000DC5 RID: 3525 RVA: 0x00012333 File Offset: 0x00010533
		public void GetColorArray(int nameID, List<Color> values)
		{
			this.ExtractColorArray(nameID, values);
		}

		// Token: 0x06000DC6 RID: 3526 RVA: 0x0001233F File Offset: 0x0001053F
		public void GetVectorArray(string name, List<Vector4> values)
		{
			this.ExtractVectorArray(Shader.PropertyToID(name), values);
		}

		// Token: 0x06000DC7 RID: 3527 RVA: 0x00012350 File Offset: 0x00010550
		public void GetVectorArray(int nameID, List<Vector4> values)
		{
			this.ExtractVectorArray(nameID, values);
		}

		// Token: 0x06000DC8 RID: 3528 RVA: 0x0001235C File Offset: 0x0001055C
		public void GetMatrixArray(string name, List<Matrix4x4> values)
		{
			this.ExtractMatrixArray(Shader.PropertyToID(name), values);
		}

		// Token: 0x06000DC9 RID: 3529 RVA: 0x0001236D File Offset: 0x0001056D
		public void GetMatrixArray(int nameID, List<Matrix4x4> values)
		{
			this.ExtractMatrixArray(nameID, values);
		}

		// Token: 0x06000DCA RID: 3530 RVA: 0x00012379 File Offset: 0x00010579
		public void SetTextureOffset(string name, Vector2 value)
		{
			this.SetTextureOffsetImpl(Shader.PropertyToID(name), value);
		}

		// Token: 0x06000DCB RID: 3531 RVA: 0x0001238A File Offset: 0x0001058A
		public void SetTextureOffset(int nameID, Vector2 value)
		{
			this.SetTextureOffsetImpl(nameID, value);
		}

		// Token: 0x06000DCC RID: 3532 RVA: 0x00012396 File Offset: 0x00010596
		public void SetTextureScale(string name, Vector2 value)
		{
			this.SetTextureScaleImpl(Shader.PropertyToID(name), value);
		}

		// Token: 0x06000DCD RID: 3533 RVA: 0x000123A7 File Offset: 0x000105A7
		public void SetTextureScale(int nameID, Vector2 value)
		{
			this.SetTextureScaleImpl(nameID, value);
		}

		// Token: 0x06000DCE RID: 3534 RVA: 0x000123B4 File Offset: 0x000105B4
		public Vector2 GetTextureOffset(string name)
		{
			return this.GetTextureOffset(Shader.PropertyToID(name));
		}

		// Token: 0x06000DCF RID: 3535 RVA: 0x000123D4 File Offset: 0x000105D4
		...
		// Token: 0x06000DD0 RID: 3536 RVA: 0x00012400 File Offset: 0x00010600
		public Vector2 GetTextureScale(string name)
		{
			return this.GetTextureScale(Shader.PropertyToID(name));
		}

		// Token: 0x06000DD1 RID: 3537 RVA: 0x00012420 File Offset: 0x00010620
