...
namespace UnityEngine
{
	...
	public sealed class Shader : Object
	{
		...
		// (get) Token: 0x06000C4A RID: 3146 RVA: 0x00010828 File Offset: 0x0000EA28
		// (set) Token: 0x06000C4B RID: 3147 RVA: 0x0001083F File Offset: 0x0000EA3F
		...
		// Token: 0x06000C4C RID: 3148 RVA: 0x00010849 File Offset: 0x0000EA49
		...
		// (get) Token: 0x06000C57 RID: 3159 RVA: 0x00010858 File Offset: 0x0000EA58
		...
		// (get) Token: 0x06000C58 RID: 3160 RVA: 0x00010870 File Offset: 0x0000EA70
		...
		// (get) Token: 0x06000C59 RID: 3161 RVA: 0x00010888 File Offset: 0x0000EA88
		...
		// Token: 0x06000C5F RID: 3167 RVA: 0x0001089E File Offset: 0x0000EA9E
		[FreeFunction("ShaderScripting::EnableKeyword")]
		...
		// Token: 0x06000C60 RID: 3168 RVA: 0x000108A7 File Offset: 0x0000EAA7
		[FreeFunction("ShaderScripting::DisableKeyword")]
		...
		// Token: 0x06000C61 RID: 3169 RVA: 0x000108B0 File Offset: 0x0000EAB0
		...
		// Token: 0x06000C62 RID: 3170 RVA: 0x000108BA File Offset: 0x0000EABA
		[FreeFunction("ShaderScripting::IsKeywordEnabled")]
		...
		// Token: 0x06000C71 RID: 3185 RVA: 0x00010914 File Offset: 0x0000EB14
		...
		// Token: 0x06000C72 RID: 3186 RVA: 0x0001096C File Offset: 0x0000EB6C
		...
		// Token: 0x06000C73 RID: 3187 RVA: 0x000109E8 File Offset: 0x0000EBE8
		...
		// Token: 0x06000C79 RID: 3193 RVA: 0x00010A53 File Offset: 0x0000EC53
		...
		// Token: 0x06000C7A RID: 3194 RVA: 0x00010A5D File Offset: 0x0000EC5D
		...
		// Token: 0x06000C83 RID: 3203 RVA: 0x00010A68 File Offset: 0x0000EC68
		...
		// Token: 0x06000C84 RID: 3204 RVA: 0x00010A80 File Offset: 0x0000EC80
		...
		// Token: 0x06000C92 RID: 3218 RVA: 0x00010A98 File Offset: 0x0000EC98
		...
		// Token: 0x06000C93 RID: 3219 RVA: 0x00010AEC File Offset: 0x0000ECEC
		...
		// Token: 0x06000C94 RID: 3220 RVA: 0x00010B40 File Offset: 0x0000ED40
		...
		// Token: 0x06000C95 RID: 3221 RVA: 0x00010B94 File Offset: 0x0000ED94
		...
		// Token: 0x06000C96 RID: 3222 RVA: 0x00010BE8 File Offset: 0x0000EDE8
		...
		// Token: 0x06000C97 RID: 3223 RVA: 0x00010C3C File Offset: 0x0000EE3C
		...
		// Token: 0x06000C98 RID: 3224 RVA: 0x00010C8F File Offset: 0x0000EE8F
		public static void SetGlobalInt(string name, int value)
		{
			Shader.SetGlobalFloatImpl(Shader.PropertyToID(name), (float)value);
		}

		// Token: 0x06000C99 RID: 3225 RVA: 0x00010CA0 File Offset: 0x0000EEA0
		public static void SetGlobalInt(int nameID, int value)
		{
			Shader.SetGlobalFloatImpl(nameID, (float)value);
		}

		// Token: 0x06000C9A RID: 3226 RVA: 0x00010CAC File Offset: 0x0000EEAC
		public static void SetGlobalFloat(string name, float value)
		{
			Shader.SetGlobalFloatImpl(Shader.PropertyToID(name), value);
		}

		// Token: 0x06000C9B RID: 3227 RVA: 0x00010CBC File Offset: 0x0000EEBC
		public static void SetGlobalFloat(int nameID, float value)
		{
			Shader.SetGlobalFloatImpl(nameID, value);
		}

		// Token: 0x06000C9C RID: 3228 RVA: 0x00010CC7 File Offset: 0x0000EEC7
		public static void SetGlobalInteger(string name, int value)
		{
			Shader.SetGlobalIntImpl(Shader.PropertyToID(name), value);
		}

		// Token: 0x06000C9D RID: 3229 RVA: 0x00010CD7 File Offset: 0x0000EED7
		public static void SetGlobalInteger(int nameID, int value)
		{
			Shader.SetGlobalIntImpl(nameID, value);
		}

		// Token: 0x06000C9E RID: 3230 RVA: 0x00010CE2 File Offset: 0x0000EEE2
		public static void SetGlobalVector(string name, Vector4 value)
		{
			Shader.SetGlobalVectorImpl(Shader.PropertyToID(name), value);
		}

		// Token: 0x06000C9F RID: 3231 RVA: 0x00010CF2 File Offset: 0x0000EEF2
		public static void SetGlobalVector(int nameID, Vector4 value)
		{
			Shader.SetGlobalVectorImpl(nameID, value);
		}

		// Token: 0x06000CA0 RID: 3232 RVA: 0x00010CFD File Offset: 0x0000EEFD
		public static void SetGlobalColor(string name, Color value)
		{
			Shader.SetGlobalVectorImpl(Shader.PropertyToID(name), value);
		}

		// Token: 0x06000CA1 RID: 3233 RVA: 0x00010D12 File Offset: 0x0000EF12
		public static void SetGlobalColor(int nameID, Color value)
		{
			Shader.SetGlobalVectorImpl(nameID, value);
		}

		// Token: 0x06000CA2 RID: 3234 RVA: 0x00010D22 File Offset: 0x0000EF22
		public static void SetGlobalMatrix(string name, Matrix4x4 value)
		{
			Shader.SetGlobalMatrixImpl(Shader.PropertyToID(name), value);
		}

		// Token: 0x06000CA3 RID: 3235 RVA: 0x00010D32 File Offset: 0x0000EF32
		public static void SetGlobalMatrix(int nameID, Matrix4x4 value)
		{
			Shader.SetGlobalMatrixImpl(nameID, value);
		}

		// Token: 0x06000CA4 RID: 3236 RVA: 0x00010D3D File Offset: 0x0000EF3D
		public static void SetGlobalTexture(string name, Texture value)
		{
			Shader.SetGlobalTextureImpl(Shader.PropertyToID(name), value);
		}

		// Token: 0x06000CA5 RID: 3237 RVA: 0x00010D4D File Offset: 0x0000EF4D
		public static void SetGlobalTexture(int nameID, Texture value)
		{
			Shader.SetGlobalTextureImpl(nameID, value);
		}

		// Token: 0x06000CA6 RID: 3238 RVA: 0x00010D58 File Offset: 0x0000EF58
		...
		// Token: 0x06000CA7 RID: 3239 RVA: 0x00010D69 File Offset: 0x0000EF69
		...
		// Token: 0x06000CA8 RID: 3240 RVA: 0x00010D75 File Offset: 0x0000EF75
		...
		// Token: 0x06000CA9 RID: 3241 RVA: 0x00010D85 File Offset: 0x0000EF85
		public static void SetGlobalBuffer(int nameID, ComputeBuffer value)
		{
			Shader.SetGlobalBufferImpl(nameID, value);
		}

		// Token: 0x06000CAA RID: 3242 RVA: 0x00010D90 File Offset: 0x0000EF90
		...
		// Token: 0x06000CAB RID: 3243 RVA: 0x00010DA0 File Offset: 0x0000EFA0
		public static void SetGlobalBuffer(int nameID, GraphicsBuffer value)
		{
			Shader.SetGlobalGraphicsBufferImpl(nameID, value);
		}

		// Token: 0x06000CAC RID: 3244 RVA: 0x00010DAB File Offset: 0x0000EFAB
		...
		// Token: 0x06000CAD RID: 3245 RVA: 0x00010DBD File Offset: 0x0000EFBD
		...
		// Token: 0x06000CAE RID: 3246 RVA: 0x00010DCA File Offset: 0x0000EFCA
		...
		// Token: 0x06000CAF RID: 3247 RVA: 0x00010DDC File Offset: 0x0000EFDC
		...
		// Token: 0x06000CB0 RID: 3248 RVA: 0x00010DE9 File Offset: 0x0000EFE9
		...
		// Token: 0x06000CB1 RID: 3249 RVA: 0x00010E04 File Offset: 0x0000F004
		...
		// Token: 0x06000CB2 RID: 3250 RVA: 0x00010E1A File Offset: 0x0000F01A
		...
		// Token: 0x06000CB3 RID: 3251 RVA: 0x00010E2D File Offset: 0x0000F02D
		public static void SetGlobalFloatArray(int nameID, float[] values)
		{
			Shader.SetGlobalFloatArray(nameID, values, values.Length);
		}

		// Token: 0x06000CB4 RID: 3252 RVA: 0x00010E3B File Offset: 0x0000F03B
		...
		// Token: 0x06000CB5 RID: 3253 RVA: 0x00010E56 File Offset: 0x0000F056
		...
		// Token: 0x06000CB6 RID: 3254 RVA: 0x00010E6C File Offset: 0x0000F06C
		...
		// Token: 0x06000CB7 RID: 3255 RVA: 0x00010E7F File Offset: 0x0000F07F
		public static void SetGlobalVectorArray(int nameID, Vector4[] values)
		{
			Shader.SetGlobalVectorArray(nameID, values, values.Length);
		}

		// Token: 0x06000CB8 RID: 3256 RVA: 0x00010E8D File Offset: 0x0000F08D
		...
		// Token: 0x06000CB9 RID: 3257 RVA: 0x00010EA8 File Offset: 0x0000F0A8
		...
		// Token: 0x06000CBA RID: 3258 RVA: 0x00010EBE File Offset: 0x0000F0BE
		...
		// Token: 0x06000CBB RID: 3259 RVA: 0x00010ED1 File Offset: 0x0000F0D1
		...
		// Token: 0x06000CCC RID: 3276 RVA: 0x000110BC File Offset: 0x0000F2BC
		public static Vector4[] GetGlobalVectorArray(string name)
		{
			return Shader.GetGlobalVectorArray(Shader.PropertyToID(name));
		}

		// Token: 0x06000CCD RID: 3277 RVA: 0x000110DC File Offset: 0x0000F2DC
		...
		// Token: 0x06000CCE RID: 3278 RVA: 0x00011100 File Offset: 0x0000F300
		public static Matrix4x4[] GetGlobalMatrixArray(string name)
		{
			return Shader.GetGlobalMatrixArray(Shader.PropertyToID(name));
		}

		// Token: 0x06000CCF RID: 3279 RVA: 0x00011120 File Offset: 0x0000F320
		...
		// Token: 0x06000CD0 RID: 3280 RVA: 0x00011143 File Offset: 0x0000F343
		...
		// Token: 0x06000CD1 RID: 3281 RVA: 0x00011153 File Offset: 0x0000F353
		public static void GetGlobalFloatArray(int nameID, List<float> values)
		{
			Shader.ExtractGlobalFloatArray(nameID, values);
		}

		// Token: 0x06000CD2 RID: 3282 RVA: 0x0001115E File Offset: 0x0000F35E
		...
		// Token: 0x06000CD3 RID: 3283 RVA: 0x0001116E File Offset: 0x0000F36E
		public static void GetGlobalVectorArray(int nameID, List<Vector4> values)
		{
			Shader.ExtractGlobalVectorArray(nameID, values);
		}

		// Token: 0x06000CD4 RID: 3284 RVA: 0x00011179 File Offset: 0x0000F379
		...
		// Token: 0x06000CD5 RID: 3285 RVA: 0x00011189 File Offset: 0x0000F389
		public static void GetGlobalMatrixArray(int nameID, List<Matrix4x4> values)
		{
			Shader.ExtractGlobalMatrixArray(nameID, values);
		}

		// Token: 0x06000CD6 RID: 3286 RVA: 0x0000E87A File Offset: 0x0000CA7A
		private Shader()
		{
		}
		...
		// Token: 0x06000CDE RID: 3294 RVA: 0x00011194 File Offset: 0x0000F394
		...
		// Token: 0x06000CE2 RID: 3298 RVA: 0x000111AC File Offset: 0x0000F3AC
		...
		// Token: 0x06000CE5 RID: 3301 RVA: 0x000111DC File Offset: 0x0000F3DC
		...
		// Token: 0x06000CE6 RID: 3302 RVA: 0x00011200 File Offset: 0x0000F400
		...
		// Token: 0x06000CE7 RID: 3303 RVA: 0x00011224 File Offset: 0x0000F424
		...
		// Token: 0x06000CE8 RID: 3304 RVA: 0x00011248 File Offset: 0x0000F448
		...
		// Token: 0x06000CE9 RID: 3305 RVA: 0x0001126C File Offset: 0x0000F46C
		...
		// Token: 0x06000CEA RID: 3306 RVA: 0x00011290 File Offset: 0x0000F490
		...
		// Token: 0x06000CEB RID: 3307 RVA: 0x000112B4 File Offset: 0x0000F4B4
		...
		// Token: 0x06000CEC RID: 3308 RVA: 0x00011304 File Offset: 0x0000F504
		...
		// Token: 0x06000CED RID: 3309 RVA: 0x0001134C File Offset: 0x0000F54C
		...
		// Token: 0x06000CEE RID: 3310 RVA: 0x000113A0 File Offset: 0x0000F5A0
		...
		// Token: 0x06000CEF RID: 3311 RVA: 0x000113E0 File Offset: 0x0000F5E0
		...
		// Token: 0x06000CF0 RID: 3312 RVA: 0x00011420 File Offset: 0x0000F620
