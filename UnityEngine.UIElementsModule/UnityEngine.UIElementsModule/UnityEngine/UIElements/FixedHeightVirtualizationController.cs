...
namespace UnityEngine.UIElements
{
	...
	internal class FixedHeightVirtualizationController<T> : VerticalVirtualizationController<T> where T : ReusableCollectionItem, new()
	{
		...
		// (get) Token: 0x060008A7 RID: 2215 RVA: 0x00020D2C File Offset: 0x0001EF2C
		...
		// Token: 0x060008A8 RID: 2216 RVA: 0x00020D40 File Offset: 0x0001EF40
		protected override bool VisibleItemPredicate(T i)
		{
			return true;
		}

		// Token: 0x060008A9 RID: 2217 RVA: 0x00020D53 File Offset: 0x0001EF53
		public FixedHeightVirtualizationController(BaseVerticalCollectionView collectionView)
			: base(collectionView)
		{
		}

		// Token: 0x060008AA RID: 2218 RVA: 0x00020D60 File Offset: 0x0001EF60
		public override int GetIndexFromPosition(Vector2 position)
		{
			return (int)(position.y / this.resolvedItemHeight);
		}

		// Token: 0x060008AB RID: 2219 RVA: 0x00020D80 File Offset: 0x0001EF80
		public override float GetItemHeight(int index)
		{
			return this.resolvedItemHeight;
		}

		// Token: 0x060008AC RID: 2220 RVA: 0x00020D98 File Offset: 0x0001EF98
		...
		// Token: 0x060008AD RID: 2221 RVA: 0x00020ED8 File Offset: 0x0001F0D8
		...
		// Token: 0x060008AE RID: 2222 RVA: 0x000210B4 File Offset: 0x0001F2B4
		...
		// Token: 0x060008AF RID: 2223 RVA: 0x0002135C File Offset: 0x0001F55C
