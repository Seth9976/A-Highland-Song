...
namespace UnityEngine.UIElements
{
	...
	public static class UQuery
	{
		...
		{
			// Token: 0x06000698 RID: 1688 RVA: 0x000188CC File Offset: 0x00016ACC
		...
		{
			// Token: 0x0600069B RID: 1691 RVA: 0x000188F3 File Offset: 0x00016AF3
			public PredicateWrapper(Func<T, bool> p)
			{
				this.predicate = p;
			}

			// Token: 0x0600069C RID: 1692 RVA: 0x00018904 File Offset: 0x00016B04
			public bool Predicate(object e)
			{
				T t = e as T;
				bool flag = t != null;
		...
		{
			// Token: 0x0600069E RID: 1694 RVA: 0x0001894A File Offset: 0x00016B4A
			public override void Traverse(VisualElement element)
			{
				base.Traverse(element);
			}

			// Token: 0x0600069F RID: 1695 RVA: 0x00018958 File Offset: 0x00016B58
			...
			// Token: 0x060006A1 RID: 1697 RVA: 0x0001896C File Offset: 0x00016B6C
			...
			// Token: 0x060006A2 RID: 1698 RVA: 0x00018A30 File Offset: 0x00016C30
		...
		internal abstract class SingleQueryMatcher : UQuery.UQueryMatcher
		{
			...
			// (get) Token: 0x060006A6 RID: 1702 RVA: 0x00018A58 File Offset: 0x00016C58
			// (set) Token: 0x060006A7 RID: 1703 RVA: 0x00018A60 File Offset: 0x00016C60
			public VisualElement match { get; set; }

			// Token: 0x060006A8 RID: 1704 RVA: 0x00018A69 File Offset: 0x00016C69
			...
			// Token: 0x060006A9 RID: 1705 RVA: 0x00018A84 File Offset: 0x00016C84
			public bool IsInUse()
			{
		...
		{
			// Token: 0x060006AC RID: 1708 RVA: 0x00018AA8 File Offset: 0x00016CA8
			...
			// Token: 0x060006AD RID: 1709 RVA: 0x00018AD0 File Offset: 0x00016CD0
		...
		{
			// Token: 0x060006B0 RID: 1712 RVA: 0x00018AEC File Offset: 0x00016CEC
			protected override bool OnRuleMatchedElement(RuleMatcher matcher, VisualElement element)
			{
				base.match = element;
				return false;
			...
			// Token: 0x060006B1 RID: 1713 RVA: 0x00018B07 File Offset: 0x00016D07
			public override UQuery.SingleQueryMatcher CreateNew()
			{
		...
		internal class IndexQueryMatcher : UQuery.SingleQueryMatcher
		{
			...
			// (get) Token: 0x060006B4 RID: 1716 RVA: 0x00018B1C File Offset: 0x00016D1C
			// (set) Token: 0x060006B5 RID: 1717 RVA: 0x00018B34 File Offset: 0x00016D34
			...
			// Token: 0x060006B6 RID: 1718 RVA: 0x00018B45 File Offset: 0x00016D45
			public override void Run(VisualElement root, List<RuleMatcher> matchers)
			{
				this.matchCount = -1;
				base.Run(root, matchers);
			...
			// Token: 0x060006B7 RID: 1719 RVA: 0x00018B58 File Offset: 0x00016D58
			protected override bool OnRuleMatchedElement(RuleMatcher matcher, VisualElement element)
			{
				this.matchCount++;
			...
			// Token: 0x060006B8 RID: 1720 RVA: 0x00018BA5 File Offset: 0x00016DA5
			public override UQuery.SingleQueryMatcher CreateNew()
			{
