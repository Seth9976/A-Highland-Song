...
namespace UnityEngine.UIElements
{
	...
	public class PanelEventHandler : UIBehaviour, IPointerMoveHandler, IEventSystemHandler, IPointerUpHandler, IPointerDownHandler, ISubmitHandler, ICancelHandler, IMoveHandler, IScrollHandler, ISelectHandler, IDeselectHandler, IPointerExitHandler, IPointerEnterHandler, IRuntimePanelComponent
	{
		...
		private class PointerEvent : IPointerEvent
		{
			...
			// (get) Token: 0x06000713 RID: 1811 RVA: 0x0001C352 File Offset: 0x0001A552
			// (set) Token: 0x06000714 RID: 1812 RVA: 0x0001C35A File Offset: 0x0001A55A
			public int pointerId { get; private set; }

			// Token: 0x170001DB RID: 475
			// (get) Token: 0x06000715 RID: 1813 RVA: 0x0001C363 File Offset: 0x0001A563
			// (set) Token: 0x06000716 RID: 1814 RVA: 0x0001C36B File Offset: 0x0001A56B
			public string pointerType { get; private set; }

			// Token: 0x170001DC RID: 476
			// (get) Token: 0x06000717 RID: 1815 RVA: 0x0001C374 File Offset: 0x0001A574
			// (set) Token: 0x06000718 RID: 1816 RVA: 0x0001C37C File Offset: 0x0001A57C
			public bool isPrimary { get; private set; }

			// Token: 0x170001DD RID: 477
			// (get) Token: 0x06000719 RID: 1817 RVA: 0x0001C385 File Offset: 0x0001A585
			// (set) Token: 0x0600071A RID: 1818 RVA: 0x0001C38D File Offset: 0x0001A58D
			public int button { get; private set; }

			// Token: 0x170001DE RID: 478
			// (get) Token: 0x0600071B RID: 1819 RVA: 0x0001C396 File Offset: 0x0001A596
			// (set) Token: 0x0600071C RID: 1820 RVA: 0x0001C39E File Offset: 0x0001A59E
			public int pressedButtons { get; private set; }

			// Token: 0x170001DF RID: 479
			// (get) Token: 0x0600071D RID: 1821 RVA: 0x0001C3A7 File Offset: 0x0001A5A7
			// (set) Token: 0x0600071E RID: 1822 RVA: 0x0001C3AF File Offset: 0x0001A5AF
			public Vector3 position { get; private set; }

			// Token: 0x170001E0 RID: 480
			// (get) Token: 0x0600071F RID: 1823 RVA: 0x0001C3B8 File Offset: 0x0001A5B8
			// (set) Token: 0x06000720 RID: 1824 RVA: 0x0001C3C0 File Offset: 0x0001A5C0
			public Vector3 localPosition { get; private set; }

			// Token: 0x170001E1 RID: 481
			// (get) Token: 0x06000721 RID: 1825 RVA: 0x0001C3C9 File Offset: 0x0001A5C9
			// (set) Token: 0x06000722 RID: 1826 RVA: 0x0001C3D1 File Offset: 0x0001A5D1
			public Vector3 deltaPosition { get; private set; }

			// Token: 0x170001E2 RID: 482
			// (get) Token: 0x06000723 RID: 1827 RVA: 0x0001C3DA File Offset: 0x0001A5DA
			// (set) Token: 0x06000724 RID: 1828 RVA: 0x0001C3E2 File Offset: 0x0001A5E2
			public float deltaTime { get; private set; }

			// Token: 0x170001E3 RID: 483
			// (get) Token: 0x06000725 RID: 1829 RVA: 0x0001C3EB File Offset: 0x0001A5EB
			// (set) Token: 0x06000726 RID: 1830 RVA: 0x0001C3F3 File Offset: 0x0001A5F3
			public int clickCount { get; private set; }

			// Token: 0x170001E4 RID: 484
			// (get) Token: 0x06000727 RID: 1831 RVA: 0x0001C3FC File Offset: 0x0001A5FC
			// (set) Token: 0x06000728 RID: 1832 RVA: 0x0001C404 File Offset: 0x0001A604
			public float pressure { get; private set; }

			// Token: 0x170001E5 RID: 485
			// (get) Token: 0x06000729 RID: 1833 RVA: 0x0001C40D File Offset: 0x0001A60D
			// (set) Token: 0x0600072A RID: 1834 RVA: 0x0001C415 File Offset: 0x0001A615
			public float tangentialPressure { get; private set; }

			// Token: 0x170001E6 RID: 486
			// (get) Token: 0x0600072B RID: 1835 RVA: 0x0001C41E File Offset: 0x0001A61E
			// (set) Token: 0x0600072C RID: 1836 RVA: 0x0001C426 File Offset: 0x0001A626
			public float altitudeAngle { get; private set; }

			// Token: 0x170001E7 RID: 487
			// (get) Token: 0x0600072D RID: 1837 RVA: 0x0001C42F File Offset: 0x0001A62F
			// (set) Token: 0x0600072E RID: 1838 RVA: 0x0001C437 File Offset: 0x0001A637
			public float azimuthAngle { get; private set; }

			// Token: 0x170001E8 RID: 488
			// (get) Token: 0x0600072F RID: 1839 RVA: 0x0001C440 File Offset: 0x0001A640
			// (set) Token: 0x06000730 RID: 1840 RVA: 0x0001C448 File Offset: 0x0001A648
			public float twist { get; private set; }

			// Token: 0x170001E9 RID: 489
			// (get) Token: 0x06000731 RID: 1841 RVA: 0x0001C451 File Offset: 0x0001A651
			// (set) Token: 0x06000732 RID: 1842 RVA: 0x0001C459 File Offset: 0x0001A659
			public Vector2 radius { get; private set; }

			// Token: 0x170001EA RID: 490
			// (get) Token: 0x06000733 RID: 1843 RVA: 0x0001C462 File Offset: 0x0001A662
			// (set) Token: 0x06000734 RID: 1844 RVA: 0x0001C46A File Offset: 0x0001A66A
			public Vector2 radiusVariance { get; private set; }

			// Token: 0x170001EB RID: 491
			// (get) Token: 0x06000735 RID: 1845 RVA: 0x0001C473 File Offset: 0x0001A673
			// (set) Token: 0x06000736 RID: 1846 RVA: 0x0001C47B File Offset: 0x0001A67B
			public EventModifiers modifiers { get; private set; }

			// Token: 0x170001EC RID: 492
			// (get) Token: 0x06000737 RID: 1847 RVA: 0x0001C484 File Offset: 0x0001A684
			...
			// (get) Token: 0x06000738 RID: 1848 RVA: 0x0001C491 File Offset: 0x0001A691
			public bool ctrlKey
			{
				get
				{
			...
			// (get) Token: 0x06000739 RID: 1849 RVA: 0x0001C49E File Offset: 0x0001A69E
			...
			// (get) Token: 0x0600073A RID: 1850 RVA: 0x0001C4AB File Offset: 0x0001A6AB
			public bool altKey
			{
				get
				{
			...
			// (get) Token: 0x0600073B RID: 1851 RVA: 0x0001C4B8 File Offset: 0x0001A6B8
			...
			// Token: 0x0600073C RID: 1852 RVA: 0x0001C4D8 File Offset: 0x0001A6D8
			...
			// Token: 0x0600073D RID: 1853 RVA: 0x0001C708 File Offset: 0x0001A908
			...
			// Token: 0x0600073F RID: 1855 RVA: 0x0001C734 File Offset: 0x0001A934
			[CompilerGenerated]
